<div class="feedbacks index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('reviewer_notes');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $feedback['Feedback']['reviewed_by']; ?>&nbsp;</td>
		<td><?php echo $feedback['Feedback']['reviewer_notes']; ?>&nbsp;</td>
		<td><?php echo $feedback['Feedback']['response']; ?>&nbsp;</td>
		<td class="actions">
